...
const FEATURES = [
  { icon: Brain,      title: "AI Contract Learning",        desc: "The Learner Agent — built on Vertex AI Agent Builder (ADK v1.0) and powered by Gemini 2.5 Pro — analyzes Dynatrace traces and extracts implicit behavioral contracts with zero manual spec writing.",                  badge: "Agent Builder", badgeColor: "bg-blue-500/15 text-blue-400 border-blue-500/25",        accent: "group-hover:border-blue-500/30"    },
